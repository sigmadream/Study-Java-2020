package com.sangkon.inaction.chapter11;
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    insurance.setName("ABC Insurance");
//    Insurance insurance = null;
    Optional<Insurance> optionalInsurance = Optional.ofNullable(insurance);
    Optional<String> name = optionalInsurance.map(Insurance::getName);
    System.out.println(name);

    Person person = new Person(Optional.of(new Car(Optional.of(new Insurance("Insurance1")))));
    Person person2 = new Person(Optional.of(new Car(Optional.of(new Insurance("Insurance2")))));
    Person person3 = new Person(Optional.of(new Car(Optional.of(new Insurance("Insurance3")))));
    Person person4 = new Person(Optional.of(new Car(Optional.of(new Insurance("Insurance4")))));
  ...
  static public Insurance findCheapestInsurance(Person person, Car car) {
    return new Insurance("Insurance");
  }
